    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            else
            {
                ...
                narratorVolumePercent = PlayerPrefs.GetFloat(NarratorVolume, 1f);
            }
        }

        private void Start()
        {
            SetVolume(PlayerPrefs.GetFloat(MusicVolume, 0.15f), AudioChannel.Music);
            SetVolume(PlayerPrefs.GetFloat(SFXVolume, 0.5f), AudioChannel.Sfx);
            SetVolume(PlayerPrefs.GetFloat(NarratorVolume, 1f), AudioChannel.Narrator);
        }
